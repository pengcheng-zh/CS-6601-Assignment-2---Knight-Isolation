...
#################################################
### THIS FILE WAS AUTOGENERATED! DO NOT EDIT! ###͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄏͏󠄄͏󠄆
#################################################
# file to edit: notebook.ipynb͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄏͏󠄄͏󠄆

import time
from isolation import Board

# Credits if any͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄏͏󠄄͏󠄆
# 1)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄏͏󠄄͏󠄆
# 2)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄏͏󠄄͏󠄆
# 3)͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄏͏󠄄͏󠄆
...
def alphabeta(player, game, time_left, depth, alpha=float("-inf"), beta=float("inf"), my_turn=True):
    ...
    # TODO: finish this function!͏︅͏︀͏︋͏︋͏󠄌͏󠄎͏󠄋͏󠄏͏󠄄͏󠄆
    if my_turn:
        best_move, val = alphabeta_max(player, game, time_left, depth, current_depth=0, alpha=float("-inf"), beta=float("inf"), my_turn=my_turn)
    else:
        best_move, val = alphabeta_min(player, game, time_left, depth, current_depth=0, alpha=float("-inf"), beta=float("inf"), my_turn=my_turn)

    return best_move, val


def alphabeta_max(player, game, time_left, depth, current_depth=0, alpha=float("-inf"), beta=float("inf"), my_turn=True):
    maxi_move = None
    max_val = float("-inf")
...
def alphabeta_min(player, game, time_left, depth, current_depth=0, alpha=float("-inf"), beta=float("inf"), my_turn=True):
    mini_move = None
    min_val = float("inf")
    ...
    for move in opp_valid_moves:
        ...
        next_move, next_val = alphabeta_max(player, game_copy, time_left, depth, current_depth, alpha, beta, my_turn=my_turn)
